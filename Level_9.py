...
while True:
    ...
    pygame.draw.rect(screen, PBRed, opponent)
    ...
    opponent_text = game_font.render(f"{opponent_score}", False, PBRed)
    screen.blit(opponent_text, (370, 315))
    player_text = game_font.render(f"{player_name}", False, Orange)
    screen.blit(player_text, (410, 50))
    opponent_text = game_font.render(f"{opponent_name}", False, PBRed)
    screen.blit(opponent_text, (300, 50))
    pygame.display.flip()
    clock.tick(60)
    ...
    if player_score == 5:
        ...
        while run:
            ...
            if Next_button.draw(screen):
                ...
                Level_7_img = pygame.image.load('7_png.png').convert_alpha()
                Level_8_img = pygame.image.load('8_png.png').convert_alpha()
                Level_9_img = pygame.image.load('9_png.png').convert_alpha()
                Level_10_img = pygame.image.load('Playoffs_image.png').convert_alpha()
                Next_img = pygame.image.load('Next_btn.png').convert_alpha()
                ...
                Level_7_button = Button.button(210, 150, Level_7_img, 0.7)
                Level_8_button = Button.button(340, 150, Level_8_img, 0.7)
                Level_9_button = Button.button(470, 150, Level_9_img, 0.7)
                Play_button = Button.button(220, 270, Level_10_img, 0.7)
                Next_button = Button.button(330, 430, Next_img, 0.5)
                ...
                while run:
                    ...
                    if Level_7_button.draw(screen):
                        print('Level 7 Completed')
                    if Level_8_button.draw(screen):
                        print('Level 8 Completed')
                    if Level_9_button.draw(screen):
