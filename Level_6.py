...
while True:
    ...
    pygame.draw.rect(screen, dodgerblue3, opponent)
    ...
    opponent_text = game_font.render(f"{opponent_score}", False, dodgerblue3)
    screen.blit(opponent_text, (370, 315))
    player_text = game_font.render(f"{player_name}", False, Orange)
    screen.blit(player_text, (410, 50))
    opponent_text = game_font.render(f"{opponent_name}", False, dodgerblue3)
            ...
            if Next_button.draw(screen):
                ...
                while run:
                    ...
                    if Level_7_button.draw(screen):
                        ...
                        Team_img = pygame.image.load('RR_VS_SRH.png').convert_alpha()
