...
while True:
    ...
    opponent_text = game_font.render(f"{opponent_score}", False, Purple)
    screen.blit(opponent_text, (370, 315))
    player_text = game_font.render(f"{player_name}", False, Orange)
    screen.blit(player_text, (410, 50))
    opponent_text = game_font.render(f"{opponent_name}", False, Purple)
            ...
            if Next_button.draw(screen):
                ...
                while run:
                    ...
                    if Level_5_button.draw(screen):
                        ...
                        Team_img = pygame.image.load('MI_VS_SRH.png').convert_alpha()
                        start_img = pygame.image.load('start_btn.png').convert_alpha()

                        Team_button = Button.button(10, 40, Team_img, 1.0)
