...
while True:
    ...
    pygame.draw.rect(screen, dodgerblue4, opponent)
    ...
    opponent_text = game_font.render(f"{opponent_score}", False, dodgerblue4)
    screen.blit(opponent_text, (370, 315))
    player_text = game_font.render(f"{player_name}", False, Orange)
    screen.blit(player_text, (410, 50))
    opponent_text = game_font.render(f"{opponent_name}", False, dodgerblue4)
            ...
            if Next_button.draw(screen):
                ...
                while run:
                    ...
                    if Level_4_button.draw(screen):
                        ...
                        Team_img = pygame.image.load('KKR_VS_SRH.png').convert_alpha()
