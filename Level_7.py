            ...
            if Next_button.draw(screen):
                ...
                while run:
                    ...
                    if Level_8_button.draw(screen):
                        ...
                        Team_img = pygame.image.load('LSG_VS_SRH.png').convert_alpha()
                        start_img = pygame.image.load('start_btn.png').convert_alpha()

                        Team_button = Button.button(20, 30, Team_img, 1.2)
